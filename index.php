...
<body class='hold-transition skin-green-light  fixed <?= $sidebar ?>'>
    ...
    <div class='wrapper'>
        <header class='main-header'>
            ...
            <a class='logo' style='background-color:#f9fafc'> <!-- reload dimatikan, refresh halaman dari tombol aplikasi apk -->
        ...
        <aside class='main-sidebar'>
            <section class='sidebar'>
                ...
                <ul class='sidebar-menu tree' data-widget='tree'>
                    ...
                    <li><a href='<?= $homeurl ?>/logout.php'><i class='fa fa-sign-in-alt fa-fw'></i>Keluar Aplikasi</a></li>
                </ul><!-- /.sidebar-menu -->
            </section>
        </aside>
